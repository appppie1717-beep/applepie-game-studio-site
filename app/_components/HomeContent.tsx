    ...
    <div className="virtual-recruitment">
      <div className="virtual-hero">
        ...
        <aside className="virtual-project" aria-label="이번 모집 안내">
          ...
          <p className="virtual-project-title">GEN 0.<br />ONE CREATOR.</p>
      ...
      <section className="virtual-section" aria-labelledby="virtual-support-title">
        <div className="virtual-section-heading">
          ...
          <h2 id="virtual-support-title">0기 크리에이터와 함께 준비합니다</h2>
      ...
      <section className="virtual-section" aria-labelledby="virtual-journey-title">
        <div className="virtual-section-heading">
          ...
          <h2 id="virtual-journey-title">지원부터 활동 시작까지 함께 준비합니다</h2>
          <p>먼저 서로를 알아보고, 함께할 수 있겠다고 판단하면 방송의 모습을 만들어 갑니다.</p>
        </div>
        <ol className="virtual-journey-grid">
          <li><span className="virtual-card-index">01 / APPLY</span><h3>이메일 지원</h3><p>자기소개와 음성을 보내주세요.</p></li>
          <li><span className="virtual-card-index">02 / TALK</span><h3>대화와 방송 테스트</h3><p>온라인으로 이야기하고 비공개 방송을 함께 해봅니다.</p></li>
          <li><span className="virtual-card-index">03 / PLAN</span><h3>활동 방향 협의</h3><p>캐릭터, 장비와 방송 계획을 함께 정합니다.</p></li>
          <li><span className="virtual-card-index">04 / PREPARE</span><h3>제작과 방송 준비</h3><p>최종 결정 후 캐릭터 제작과 방송 환경 테스트를 거쳐 활동을 시작합니다.</p></li>
        </ol>
      ...
      <section className="virtual-section virtual-apply" id="virtual-apply" aria-labelledby="virtual-apply-title">
        <div className="virtual-section-heading">
          ...
          <h2 id="virtual-apply-title">0기 크리에이터 지원 안내</h2>
