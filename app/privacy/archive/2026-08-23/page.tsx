    ...
    <div id="top" className="privacy-page">
      ...
      <main id="policy-content">
        <section className="privacy-hero section-pad" aria-labelledby="policy-title">
          ...
          <h1 id="policy-title">
            개인정보처리방침{" "}
            <span className="privacy-edition">2026년 8월 23일 보관본</span>
          </h1>
          <p>
            2026년 8월 23일부터 2026년 8월 28일 변경본 적용 직전까지 공개된 애플파이
            게임 스튜디오 공식 홈페이지의 개인정보처리방침입니다.
          </p>
          <span className="draft-note">
            적용 기간 2026년 8월 23일 ~ 2026년 8월 28일 변경본 적용 직전
          </span>
        </section>
