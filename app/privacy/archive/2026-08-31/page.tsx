...
export const metadata: Metadata = {
  title: { absolute: "개인정보처리방침 2026년 8월 31일 보관본 | 에르시안" },
  description: "에르시안 공식 홈페이지 개인정보처리방침의 2026년 8월 31일 보관본입니다.",
  alternates: {
    canonical: "/privacy/archive/2026-08-31",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    ...
    locale: "ko_KR",
    siteName: "ERSIYAN",
    url: "/privacy/archive/2026-08-31",
    title: "개인정보처리방침 2026년 8월 31일 보관본 | 에르시안",
    description: "에르시안 공식 홈페이지 개인정보처리방침의 2026년 8월 31일 보관본입니다.",
    images: [
      {
...
export default function ArchivedPrivacyPolicy20260831() {
  return (
    <div id="top" className="privacy-page">
      ...
      <main id="policy-content">
        <section className="privacy-hero section-pad" aria-labelledby="policy-title">
          ...
          <h1 id="policy-title">
            개인정보처리방침{" "}
            <span className="privacy-edition">2026년 8월 31일 보관본</span>
          </h1>
          <p>
            2026년 8월 31일부터 2026년 9월 5일 안내 정정본 적용 직전까지
            공개된 에르시안 공식 홈페이지의 개인정보처리방침입니다.
          </p>
          <span className="draft-note">
            최초 시행일 2026년 8월 22일 · 적용 기간 2026년 8월 31일 ~ 2026년 9월 5일 정정본 적용 직전
          </span>
        </section>
