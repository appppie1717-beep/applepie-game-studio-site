...
const worldTopics: Array<{
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "세 회사는 모두 같은 업종을 운영하며 인프라와 군사력도 거의 대등합니다. 차이는 안정, 만족, 성능 중 무엇을 우선하는가에 있습니다. 정부가 남아 있는 이유는 기업들 대신 행정 업무를 처리하기 때문입니다.",
    ],
    facts: ["대등한 인프라와 군사력", "서로 다른 삶의 우선순위", "서로를 견제하는 세 권력"],
  },
  {
    id: "contractor",
    index: "03",
    ...
    paragraphs: [
      "순수인간은 전체 인구의 0.9%뿐입니다. 나머지 사람들은 각각 한 기업과 평생계약을 맺고 살아가며, 기업이 존속하는 동안 다른 회사로 옮길 수 없습니다. 플레이어는 기업에 속하지 않은 드문 독립 계약자입니다.",
      "한 기업이 직접 움직이면 충돌이 될 회수, 호송, 경비와 조사를 대신 맡습니다. 작은 의뢰로 시작한 계약은 점차 도시의 더 높은 이해관계로 이어집니다.",
    ],
    facts: ["순수인간 0.9%", "평생계약은 기업 존속 중 이전 불가", "세 기업의 현장 의뢰 수행"],
  },
  {
    id: "companions",
    index: "04",
    ...
    <>
      ...
      >
        <div className={classes.sectionIntro}>
          ...
          <span>
            여기에는 세계관의 핵심만 간추렸습니다. 도시의 권력 구조와 평생계약, 세 기업과 AI 동행자의 이야기는 <a href="/velsien-summit/world">현재 세계관 공개본</a>에서 처음부터 읽을 수 있습니다.
          </span>
        </div>
