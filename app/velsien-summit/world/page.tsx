...
const description =
  "벨시엔 서밋을 처음 보는 사람을 위한 공개 세계관. 정부보다 강하고 인프라와 군사력이 대등한 세 기업, 바꿀 수 없는 평생계약, 0.9%의 순수인간, 인간형 AI와 중립계약자의 이야기를 설명합니다.";
...
const companies = [
  {
    ...
    direction: "안정과 보장",
    slogan: "내일을 더 확실하게.",
    copy: "오리센은 예측 가능한 내일을 약속합니다. 의료, 주거, AI와 생활 기반을 설계할 때 안정성과 지속성을 우선합니다.",
  ...
  },
  {
    ...
    shadow: "원하는 경험을 회사가 설계할수록 개인의 취향과 생활 방식도 그 회사의 기준에 묶입니다.",
...
const societySteps = [
  ...
  },
  {
    number: "02",
    title: "기업이 생활망을 묶습니다",
    copy: "세 기업은 모두 같은 업종을 운영합니다. 각자 주거와 식사, 의료, 교통, 통신, 개인 AI까지 이어지는 생활망을 제공합니다.",
  },
  {
    number: "03",
    title: "시민이 평생계약을 고릅니다",
    copy: "한 기업과 맺은 계약은 그 회사가 존속하는 동안 바꿀 수 없습니다. 기기와 데이터, 관계까지 한 생활망 안에 쌓입니다.",
  },
  {
    number: "04",
...
const storySteps = [
  ...
  },
  {
    number: "03",
    title: "평생계약의 전쟁",
    copy: "평생계약으로 형성된 생활망의 영향력을 둘러싼 경쟁이 격해집니다. 호송과 회수, 시설 확보 같은 현장 계약이 더 큰 분쟁의 일부가 됩니다.",
  },
  {
    number: "04",
    title: "중립성의 가격",
...
const worldTerms = [
  ...
  { term: "평생 생태계 계약", meaning: "한 기업의 생활망에 평생 속하는 계약. 그 기업이 무너지지 않는 한 다른 기업으로 옮길 수 없음" },
  { term: "순수인간", meaning: "신체를 개조하지 않고 기업과 평생계약도 맺지 않은 사람. 이 세계 사람 중 0.9%에 해당" },
        ...
        <section className={styles.hero} aria-labelledby="world-title">
          ...
          <div className={styles.heroContent}>
            ...
            <p className={styles.heroLead}>
              ...
              RPG입니다. 이곳 인구의 0.9%만 순수인간이며, 나머지는 한 기업과
              평생계약을 맺고 살아갑니다. 당신은 기업에 속하지 않은 순수인간
              계약자입니다.
            </p>
        ...
        <section id="society" className={`${styles.chapter} ${styles.societyChapter}`} aria-labelledby="society-title">
          <div className={styles.sectionHeading}>
            ...
            <span>
              ...
              개인 AI까지 이어지는 삶의 방식을 고릅니다. 세 기업은 이 모든
              기반과 군사력까지 거의 같은 수준으로 갖추고 있습니다.
            </span>
          </div>
          ...
          <div className={styles.contractPanel}>
            <div>
              ...
              <h3>평생 생태계 계약</h3>
              <span>
                한 기업의 생활망에 평생 속하는 계약입니다. 생필품과 의료,
                신체개조의 유지 관리, 주거·교통·통신·개인 AI가 서로 연결됩니다.
                기업에는 고객 한 사람의 생활과 데이터가 평생 쌓입니다.
              </span>
            </div>
            <div>
              ...
              <p className={styles.contractTradeoff}>
                한번 계약하면 그 기업이 무너지지 않는 한 계약을 끊고 경쟁 기업으로
                옮길 수 없습니다. 생활에 필요한 기기와 의료, 데이터와 시설까지
                한 회사의 인프라 안에서 사용하며 살아갑니다.
              </p>
            </div>
          </div>
          <div className={styles.bodyCopy}>
            <p>
              정부는 남아 있지만 세 기업 가운데 어느 한 곳에도 맞설 힘이
              없습니다. 세 기업은 각각 정부를 무너뜨릴 수 있을 만큼 강합니다.
              다만 주민등록과 민원, 법률·외교 같은 번거로운 공공 행정을 정부가
              계속 맡아주는 편이 기업에도 유용하기 때문에 굳이 정부를
              없애지 않습니다. 세 기업 사이의
              균형은 각자가 지닌 거의 대등한 힘에서 나옵니다. 정부는 이
              기업들을 통제하지 못합니다.
            </p>
            <p>
              이 세계 사람 중 순수인간은 0.9%뿐입니다. 나머지는 모두 세 기업
              가운데 한 곳과 평생계약을 맺고 그 기업의 인프라 안에서 살아갑니다.
              어느 회사의 계약자인지는 단순한 서비스 취향이 아니라 평생의
              생활 조건입니다. 회사가 존속하는 동안 다른 기업으로 갈아탈 수
              없습니다.
            </p>
          </div>
        </section>
        ...
        <section id="companies" className={`${styles.chapter} ${styles.companiesChapter}`} aria-labelledby="companies-title">
          <div className={styles.sectionHeading}>
            ...
            <span>
              ...
              모두 의료, 주거, AI, 금융, 도시 기반을 갖추고 있으며 군사력도
              거의 대등합니다. 차이는 각 회사가 추구하는 가치와 같은 문제를
              해결할 때의 우선순위에 있습니다.
            </span>
          </div>
          ...
          <div className={styles.companyExample}>
            <div className={styles.exampleIntro}>
              ...
              <span>
                ...
                세 회사는 같은 업종에서 활동하지만, 같은 제품에도 서로 다른
                가치와 우선순위를 적용합니다.
              </span>
            </div>
          ...
          <p className={styles.companyNote}>
            ...
            있습니다. 시민은 약속과 그 비용을 함께 고르지만, 평생계약을
            체결한 뒤에는 다른 기업을 다시 고를 수 없습니다.
          </p>
        </section>
          ...
          <div className={styles.splitStory}>
            ...
            <div className={styles.splitCopy}>
              <p className={styles.largeCopy}>
                ...
                않은, 이 세계에서 0.9%에 해당하는 드문 순수인간입니다.
              </p>
              <p>
                세계 안에서 쓰는 공식 명칭은 아직 정해지지 않았습니다. 평범한 시민에게는
